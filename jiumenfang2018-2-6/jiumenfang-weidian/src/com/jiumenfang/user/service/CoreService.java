...
import com.jiumenfang.user.bean.autoReply.MessageResponse;
import com.jiumenfang.utils.MessageUtil;
import com.jiumenfang.robot.FormatXmlProcess;
import com.jiumenfang.robot.TulingApiProcess;
		...
		try {
			...
			if (msgType.equals(MessageUtil.REQ_MESSAGE_TYPE_TEXT)) {
				...
				if (eventType.equals(MessageUtil.EVENT_TYPE_SUBSCRIBE)) {// 订阅
					respContent = "欢迎关注小酱仙！不一样的酱！不一样的面！小仙想跟您聊聊呢~~~";
					return MessageResponse.getTextMessage(fromUserName , toUserName , respContent);
